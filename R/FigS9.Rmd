...
```{r SuppFig9_function, echo=FALSE}
  ...
  F_replicateTec=function(patient,Tmpt){
    ...
    DF_ab[[cellfilter]]=data.frame(cell=cellfilter,r=r,r_cut=r_cut,
                                   nb_IS_filt=length(IS_selected),
...
#### _**Supp. Figure 9 : Technical Replicates correlation**_

```{r SuppFig9 ,echo=FALSE,warning=FALSE,message=FALSE,fig.width=8,fig.height=6}

## Calling the previous function to print the plots
