...
### intSites_original <- read.csv('../Data/intSites.noMergedSamples.csv', header = TRUE)
...
intSites=data.frame(intSites@elementMetadata)
 ...
 intSites$cellType=factor(intSites$cellType,levels=levels(intSites$cellType),
                          labels=c( "Bcells","BM_Bcells","BM_Granulocytes", "BM_Monocytes" ,
                                    "BM_NKcells", "BM_Tcells" ,"Granulocytes" ,
